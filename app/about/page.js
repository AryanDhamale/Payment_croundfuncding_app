    ...
    return (
        <div className="container p-6 text-white w-full md:w-[80%] mx-auto">
            ...
            <section className="mb-12 flex items-center gap-x-4">
                <img src="/mission.avif" alt="Our Mission" className="w-30 rounded-lg shadow-md" />
                <div>
            ...
            <section className="mb-12 flex items-center gap-x-4 ">
                <img src="/team.jpg" alt="Our Team" className="size-30 rounded-lg shadow-md" />
                <div>
            ...
            <section className="mb-12 flex items-center gap-x-4">
                <img src="/history.avif" alt="Our History" className="size-30 rounded-lg shadow-md" />
                <div>
