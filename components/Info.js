        ...
        <div className="text-white py-16 flex flex-col items-center border-b-2 border-gray-700">
          ...
          <div className=" w-[90%] grid grid-cols-1 md:grid-cols-3 gap-x-8 gap-y-10 md:gap-y-0">
             <div className="flex flex-col justify-center items-center">
                <Image src="/man.gif" alt="this is an image" className="rounded-full" width={120} height={120} />
             ...
             <div className="flex flex-col justify-center items-center">
                <Image src="/coin.gif" alt="this is an image" className="rounded-full" width={120} height={120} />
             ...
             <div className="flex flex-col justify-center items-center">
                <Image src="/group.gif" alt="this is an image" className="rounded-full bg-white" width={120} height={120} />
